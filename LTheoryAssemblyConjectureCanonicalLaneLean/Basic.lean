/-!
# l-theory-assembly-conjecture-canonical-lane Lean migration boundary
...
`LTheoryAssemblyConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "l-theory-assembly-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/l-theory-assembly-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the L-theory assembly conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["geometric-topology", "k-theory", "l-theory", "mathematical-proof", "reproducibility", "assembly-maps", "l-theory-assembly", "canonical-lane", "local-to-global", "manifold-constrained"]
