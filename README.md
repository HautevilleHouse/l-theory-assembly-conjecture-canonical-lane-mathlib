# L Theory Assembly Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/l-theory-assembly-conjecture-canonical-lane-mathlib.git
cd l-theory-assembly-conjecture-canonical-lane-mathlib
lake exe
lake build
```
